# 🔍 KNOCK – AI‑Accelerated nmap Wrapper

[![Version](https://img.shields.io/badge/version-7.4-blue)](https://github.com/your-username/knock)
[![License](https://img.shields.io/badge/license-MIT-green)](LICENSE)
[![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen)](https://github.com/your-username/knock/pulls)
...
- **🔧 More Full Then nmap Compatibility** – every flag works (scan types, scripts, OS detection, evasion, output formats, etc.).
